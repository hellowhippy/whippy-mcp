...
export const tools = [
...

  {
    ...
    description:
      'Send or schedule an SMS or WhatsApp message via Whippy. Phone numbers are automatically formatted to E.164 format. Schedule at is optional and must be in ISO 8601 format. From number must be a valid phone number that supports SMS or WhatsApp in the organization.',
    requireUserConfirmation: true,
    schema: {
